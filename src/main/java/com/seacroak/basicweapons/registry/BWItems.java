...
public class BWItems {
    ...
    public static void init() {
        ...
        if (bronze_mod_loaded)
            items.add(new ItemInfo("dagger", "bronze_dagger", () -> new DaggerItem(BronzeToolMaterial.INSTANCE, new Item.Settings().attributeModifiers(DaggerItem.createAttributeModifiers(
        ...
        /* 8.5 */
        if (bronze_mod_loaded)
            items.add(new ItemInfo("hammer", "bronze_hammer", () -> new HammerItem(BronzeToolMaterial.INSTANCE, new Item.Settings().attributeModifiers(HammerItem.createAttributeModifiers(
        ...
        /* 14.5 */
        if (bronze_mod_loaded)
            items.add(new ItemInfo("club", "bronze_club", () -> new ClubItem(BronzeToolMaterial.INSTANCE, new Item.Settings().attributeModifiers(ClubItem.createAttributeModifiers(
        ...
        /* 20.5*/
        if (bronze_mod_loaded)
            items.add(new ItemInfo("spear", "bronze_spear", () -> new SpearItem(BronzeToolMaterial.INSTANCE, new Item.Settings().attributeModifiers(SpearItem.createAttributeModifiers(
        ...
        /* 26.5*/
        if (bronze_mod_loaded)
            items.add(new ItemInfo("quarterstaff", "bronze_quarterstaff", () -> new QuarterstaffItem(BronzeToolMaterial.INSTANCE, new Item.Settings().attributeModifiers(QuarterstaffItem.createAttributeModifiers(
