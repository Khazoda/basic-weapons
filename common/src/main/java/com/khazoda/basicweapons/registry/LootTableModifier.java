...
public class LootTableModifier {
  ...
  static {
    ...
    // Overworld - Iron, Gold
    LOOT_TABLE_CONFIGS.put(SIMPLE_DUNGEON, new LootConfig(WeaponRegistry.getItemsByMaterial(Tiers.IRON), false, false));
    LOOT_TABLE_CONFIGS.put(ABANDONED_MINESHAFT, new LootConfig(WeaponRegistry.getItemsByMaterial(Tiers.IRON), false, false));
    ...
    LOOT_TABLE_CONFIGS.put(VILLAGE_WEAPONSMITH, new LootConfig(WeaponRegistry.getItemsByMaterial(Tiers.IRON), false, false));
